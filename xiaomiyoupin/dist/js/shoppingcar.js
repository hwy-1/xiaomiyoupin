            ...
            success: function (arr) {
                ...
                if (cookieStr) {
                    ...
                    for (var i = 0; i < newArr.length; i++) {
                        ...
                        // NUM += newArr[i].pice * newArr[i].num;
                    ...
                    for (var k = 0; k < cookieArr.length; k++) {
                        Pice += cookieArr[k].num * cookieArr[k].pice;
                        NUM += cookieArr[k].num
                    }
                    ...
                    $(".select-text").on("click", function () {
                        if (flag) {
                            ...
                            $(".total-price span").html("合计：￥" + Pice)
                            $(".Selected").html(NUM)
                            flag = false;
                        } else {
                            flag = true;
                            $(this).css("background-position", "0px -507px");
                            $(".select-icon").css("background-position", "0px -507px");

                            // console.log("取消点击")
                            $(".total-price span").html("合计：￥" + 0.00)
                            $(".Selected").html(0)
                        }
