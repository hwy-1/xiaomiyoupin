    ...
    function downSeckillPic() {
        $.ajax({
            ...
            success: function (arr) {
                    ...
                    <a href=""><img src=${arr[i].img} alt="">
                        <div>
                            ...
                            <p>
                                ...
                                <span class="mark-pice">
                                    <span>¥</span>
                                    <span>${arr[i].markPice}</span>
                ...
                $("#seckill dl li").eq(0).click(antiShake(function () {
                    if (j >= 2) {
                ...
                //左右滚动
                $("#seckill dl li").eq(1).click(antiShake(function () {
                    if (j <= 6) {
                ...
                // 变色
                $("#seckill dl li").eq(0).hover(function () {
                    if (j >= 2) {
                ...
                // 变色
                $("#seckill dl li").eq(1).hover(function () {
                    if (j <= 6) {
